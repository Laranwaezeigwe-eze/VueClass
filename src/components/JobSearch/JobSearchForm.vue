  ...
  >
    ...
    <div class="flex flex-nowrap flex-1 h-full text-base font-light">
      <div class="relative flex items-center flex=1 h-full pr-3">
        ...
        <TestInput v-model="role" placeholder="Software engineer" />
      </div>
      ...
      <div class="relative flex items-center flex-1 h-full pl-3">
        ...
        <TestInput v-model="location" placeholder="Los Angeles" />
      </div>
    </div>
...
import TestInput from "@/components/Shared/TestInput.vue";
export default {
  name: "JobSearchForm",
  components: { ActionButton, TestInput },
  data() {
    return {
      role: "",
      location: "",
